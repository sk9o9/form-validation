    ...
    <div className="grid place-content-center mt-6">
      <form onSubmit={handleSubmit(formSubmit)} className="flex flex-col gap-4">
        ...
        <div className="flex justify-end mt-4">
          <button class="text-white bg-linear-to-r from-purple-500 to-pink-500 hover:bg-linear-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5 rounded-3xl">
            Submit
          </button>
        </div>
      </form>
